/*
  ...
  - You are about to drop the column `code` on the `Menu` table. All the data in the column will be lost.
  - You are about to drop the column `level` on the `Menu` table. All the data in the column will be lost.
